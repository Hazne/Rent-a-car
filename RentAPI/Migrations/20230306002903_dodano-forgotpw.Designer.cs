...
namespace RentAPI.Migrations
{
    ...
    [Migration("20230306002903_dodano-forgotpw")]
    partial class dodanoforgotpw
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentAPI.Models.ForgotPassword", b =>
                {
                    b.Property<int>("ForgotPasswordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ForgotPasswordId"), 1L, 1);

                    b.Property<DateTime>("DatumIstekaTokena")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("RentAPI.Models.Komentar", b =>
                {
                    ...
                    b.HasOne("RentAPI.Models.Rezervisanje", "Rezervisanje")
                        .WithMany()
                        .HasForeignKey("RezervisanjeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
